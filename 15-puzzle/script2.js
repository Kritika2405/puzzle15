...
function clickTile(row,col)
{
    ...
    if(tile!="tile16");
    {
        ...
        if(col<4)
        {
            if(document.getElementById("cell"+row.toString()+(col+1).toString()).className=="tile16")
            {
        ...
        if(row>1)
        {
            if(document.getElementById("cell"+(row-1).toString()+col.toString()).className=="tile16")
            {
